...
namespace DiabetesContolApp.Service
{
    ...
    public class GroceryService : IGroceryService
    {
        ...
        {
            return new GroceryService(GroceryRepo.GetGroceryRepo(), GroceryLogRepo.GetGroceryLogRepo(), new LogRepo(), ReminderRepo.GetReminderRepo(), DayProfileRepo.GetDayProfileRepo());
        }
