...
namespace DiabetesContolApp.Persistence.Interfaces
{
    public interface ILogDatabase
    {
        ...
        public Task<List<LogModelDAO>> GetAllLogsWithDayProfileIDAsync(int dayProfileID);
        public Task<List<LogModelDAO>> GetAllLogsWithReminderIDAsync(int reminderID);
